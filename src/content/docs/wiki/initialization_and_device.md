...
- **Pipelines and swapchains**: `create_raster_pipeline`, `create_compute_pipeline`, `create_ray_tracing_pipeline`, `create_swapchain`. See [Pipelines](/wiki/pipelines/), [Pipeline Manager](/wiki/pipeline-manager/), and [Swapchain](/wiki/swapchain/).
